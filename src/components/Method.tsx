  ...
  return (
    <section id="method" className="border-t border-line bg-bg py-24 sm:py-32">
      <div className="shell">
        ...
        <div ref={spot.ref} {...spot.bind} className="relative mt-16 rounded-2xl">
          <motion.div
            variants={stagger}
            initial="hidden"
            whileInView="show"
          ...
          {/* pointer-following spotlight: soft glow + border highlight */}
          <div
            className="spot-glow pointer-events-none absolute inset-0 rounded-2xl mix-blend-screen"
            aria-hidden="true"
          />
          <div
            className="spot-border pointer-events-none absolute inset-0 rounded-2xl"
            aria-hidden="true"
          />
        </div>
